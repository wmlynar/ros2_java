...
wget https://github.com/wmlynar/ros2_java_maven_repo/raw/master/ros2-java-libs-bionic-0.0.1-SNAPSHOT.zip
unzip ros2-java-libs-bionic-0.0.1-SNAPSHOT.zip
rm ros2-java-libs-bionic-0.0.1-SNAPSHOT.zip
